...
created: 2026-03-31T01:36:54.502+05:30
modified: 2026-03-30T19:56:56.438+05:30
published: 2026-03-30T19:56:56.438+05:30
tags:
  - Contributions
---
...
1. Install NodeJS and NPM by clicking on this link https://nodejs.org/en/download/prebuilt-installer, choose the one that fits your operating system. Click on the installer to start the installer.
   ...
   ![[-- Contribution --/Images/Setting up/Installing NPM and NodeJS/{E5D02357-CF3E-49E0-B9AD-383C0DF39FAE}.png]]
   ...
   ![[-- Contribution --/Images/Setting up/Installing NPM and NodeJS/{887DF2A6-49ED-46B5-AB28-FD6CE9749B0B}.png]]

   After doing this click the `Next` button.

   ![[-- Contribution --/Images/Setting up/Installing NPM and NodeJS/{E6427019-04AE-46A9-9B01-48DD5ACD484D}.png]]
...
![[-- Contribution --/Images/Setting up/Installing VS Code/{0D8C5453-6072-47F8-951F-CFE05350A43C}.png]]
...
![[-- Contribution --/Images/Setting up/Installing VS Code/{F192901F-CEC1-46F1-95E4-7A29FA17EC59}.png]]
...
3. Clicking on the button will open a new tab in your browser which require you to sign in with your Github account. It will look a bit like this:
   ...
   ![[-- Contribution --/Images/Setting up/Installing VS Code/{C7046EBB-B856-44DA-92B7-6F3A9D700598}.png]]
   ...
   ![[-- Contribution --/Images/Setting up/Installing VS Code/{280C431D-3B37-46AA-A894-0A134042D4B6}.png]]
...
2. Accept the GNU General Public License by clicking Next
   ...
   ![[-- Contribution --/Images/Setting up/Installing Git/{7142485C-6E8F-44B9-857E-3850B10D3088}.png]]

3. Accept all the Checkboxes and Click Next

   ![[-- Contribution --/Images/Setting up/Installing Git/{A292B9AA-73DF-4DD1-8426-30B860A04710}.png]]

4. Click on the dropdown menu and select `Use Visual Studio Code as Git's default Editor`. After Selecting Click Next.

   ![[-- Contribution --/Images/Setting up/Installing Git/{DE680762-D115-42AF-B55B-67BD7E1D5034}.png]]

5. Leave things as it is and click next.

   ![[-- Contribution --/Images/Setting up/Installing Git/{DC534DAF-7877-4BF3-A399-8D3511253C31}.png]]

6. Leave things as it is and click next.

   ![[-- Contribution --/Images/Setting up/Installing Git/{BEEB7078-FBA8-470C-832C-15BCA56CFE2C}.png]]

7. Leave this as it is, and click next.

   ![[-- Contribution --/Images/Setting up/Installing Git/{AE4C754B-03D3-4F8C-8AF7-6F09145FEAC9}.png]]

8. Leave things as it is, and click next.

   ![[-- Contribution --/Images/Setting up/Installing Git/{A4B006E7-73DF-4F66-852D-96E187318DBB}.png]]

9. Leave things as it is, and click next

   ![[-- Contribution --/Images/Setting up/Installing Git/{F9B12053-B963-4D96-925A-3E5E97B45139}.png]]

10. Leave things as it is, and click next.

    ![[-- Contribution --/Images/Setting up/Installing Git/{8D1002B4-14D5-4250-874A-4C7B641AE907} 1.png]]

11. Leave things as it is, and click next.
    ![[-- Contribution --/Images/Setting up/Installing Git/{7F692884-3D12-4970-B253-E3C283098E1C}.png]]

12. Leave things as it, and click next.

    ![[-- Contribution --/Images/Setting up/Installing Git/{097F7A87-912E-47DC-B540-2A909A1AE364}.png]]

13. Leave things as it is and click Install.
    ![[-- Contribution --/Images/Setting up/Installing Git/{9337CDC1-EB2A-432F-98AF-2655ABCA8A84}.png]]
...
3. Under Files, a dropdown menu in the top left, click the button labelled `options`. It should open a pop up menu and should look a bit like this :
   ...
   ![[-- Contribution --/Images/Setting up/Installing Github Desktop/{3CBC4BE8-2569-4C0B-A97E-1CB05E3DDD30}.png]]
...
5. Click `Git` in the drawer on the left.
   ...
   ![[-- Contribution --/Images/Setting up/Cloning the project/{9DC8FECA-42AB-4C05-8436-69B090DBFAAC}.png]]
...
2. Under `Files`, click `Clone a repository`. A popup window should open that looks a bit like this :
   ...
   ![[-- Contribution --/Images/Setting up/Cloning the project/{349BD2F6-50FE-4323-BF64-ACF5F45E2A4B}.png]]
...
4. After the repository is successfully cloned, your Github Desktop will look something like this:
   ...
   ![[-- Contribution --/Images/Setting up/Cloning the project/{7906EE7F-DFEE-4A5B-8D46-56CC689F8066}.png]]
...
6. Click `Open in Visual Studio Code` button. This will open the Notes folder in VS Code, and it will look somewhat like this:
   ...
   ![[-- Contribution --/Images/Setting up/Cloning the project/{5A3B4460-ECE3-4440-B65D-CAA48F0AD0C5}.png]]

7. Open the in-built terminal by clicking `ctrl` + `~` buttons on your keyboard. It will look a bit like this:

   ![[-- Contribution --/Images/Setting up/Cloning the project/{F59C9C96-A940-41DA-B4E4-128A949B3DC9}.png]]
...
>
> ![[-- Contribution --/Images/Setting up/Installing VS Code/Pasted image 20250106220247.png]]
>
...
1. Under Files there will be a folder called "Setup Successful". In this folder there will be a file called, "Success.md". Click on that file and open it up. It will look a bit like this:
   ...
   ![[-- Contribution --/Images/Setting up/Cloning the project/{A145526C-C087-4C4F-A146-889D1BFF8B2D}.png]]
...
4. Running the above command, will produce and output that resembles this:
   ...
   ![[-- Contribution --/Images/Setting up/Cloning the project/{55F280F2-33E4-4B70-8125-1AF189E18FBA}.png]]

# Opening the folder in Obsidian

1. Open obsidian. It will look a bit like this:

   ![[-- Contribution --/Images/Setting up/Opening the folder in Obsidian/{B5ABCE18-6DD2-43B4-BA21-27061C57B47A}.png]]
...
2. Click on `Open foler as vault` and a file select window will open. Navigate to `C:\Users\harsh\Documents\GitHub\Notes` and select the folder `content`. Here is a picture of that:
   ...
   ![[-- Contribution --/Images/Setting up/Opening the folder in Obsidian/Pasted image 20241230234126.png]]

3. Upon clicking on it Obsidian will open. It should look like this:

   ![[-- Contribution --/Images/Setting up/Opening the folder in Obsidian/{3E17910A-FF4A-4110-ABCB-85EE8EE7239C}.png]]
